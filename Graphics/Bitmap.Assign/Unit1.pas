...
begin
  ...
  Image6.Picture.Bitmap.Assign(TImage(Sender).Picture.Bitmap);
  case Image6.Picture.Bitmap.PixelFormat of
    pf1bit   : Label28.Caption := 'PF 1 bit';
    pf4bit   : Label28.Caption := 'PF 4 bit';
    pf8bit   : Label28.Caption := 'PF 8 bit';
    pf15bit  : Label28.Caption := 'PF 15 bit';
    pf16bit  : Label28.Caption := 'PF 16 bit';
    pf24bit  : Label28.Caption := 'PF 24 bit';
    pf32bit  : Label28.Caption := 'PF 32 bit';
  else {pfCustom}
